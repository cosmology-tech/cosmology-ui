...
export declare const ChangeChainDropdown: ({ data, selectedItem, loading, disabled, styleProps, className, customComponents, onChange }: ChangeChainDropdownType) => JSX.Element;
